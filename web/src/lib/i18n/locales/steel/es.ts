...
const steelEs: Record<string, string> = {
  ...
  'generator.assume.latticeBasesPinnedNoOutOfPlane': 'Columnas reticuladas con bases articuladas: el modelo no tiene restricción fuera del plano del pórtico. Sin arriostramiento longitudinal es un mecanismo.',
