...
const steelPt: Record<string, string> = {
  ...
  'generator.assume.columnCapSharesReaction': 'A cabeceira da coluna distribui a reação para os dois banzos.',
  ...
  'generator.assume.latticeBasesPinnedNoOutOfPlane': 'Colunas treliçadas com bases rotuladas: o modelo não tem restrição fora do plano do pórtico. Sem contraventamento longitudinal é um mecanismo.',
