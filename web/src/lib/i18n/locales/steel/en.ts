...
const steelEn: Record<string, string> = {
  ...
  'generator.assume.latticeBasesPinnedNoOutOfPlane': 'Latticed columns on pinned bases: the model has no out-of-plane restraint. Without longitudinal bracing it is a mechanism.',
